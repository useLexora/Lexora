...
<template>
  <section class="desktop-task-context-panel" data-testid="task-context-panel">
    ...
    <div v-show="activeTabId" :id="panelId" class="desktop-task-context-panel__body" role="tabpanel" :aria-labelledby="activeTabId ? `${panelId}-${activeTabId}` : undefined">
      <slot />
    </div>
    <div v-if="!activeTabId" class="desktop-task-context-panel__empty">
