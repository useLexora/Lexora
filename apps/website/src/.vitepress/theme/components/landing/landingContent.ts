const zh = {
  ...
  faq: {
    ...
    items: [
      ...
      { question: '支持哪些系统？也有桌宠吗？', answer: '支持 Windows、Ubuntu / Debian 的 x64 与 ARM64，Arch Linux x64，以及 macOS 15+ 的 Apple Silicon。macOS 首次安装需按指南执行 xattr 命令。原生桌宠目前仅支持 Linux。' },
...
const en: typeof zh = {
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'Which platforms are supported? What about the pet?', answer: 'Windows and Ubuntu / Debian support x64 and ARM64; Arch Linux supports x64; macOS 15+ supports Apple Silicon. The first macOS installation needs the xattr command in the guide. The native desktop pet currently supports Linux only.' },
