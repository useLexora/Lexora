const zh = {
  ...
  faq: {
    ...
    items: [
      ...
      { question: '支持哪些系统？也有桌宠吗？', answer: '支持 Windows、Ubuntu / Debian 的 x64 与 ARM64，Arch Linux x64，以及 macOS 26+ 的 Apple Silicon。macOS 首次安装需按指南执行 xattr 命令。原生桌宠目前仅支持 Linux。' },
  ...
  final: {
    ...
    download: '下载 Lexora',
    guide: '从第一个任务开始',
    platforms: 'macOS · Windows · Ubuntu / Debian · Arch Linux',
    note: 'x64 / ARM64 安装包 · 使用你自己的模型服务',
...
const en: typeof zh = {
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'Which platforms are supported? What about the pet?', answer: 'Windows and Ubuntu / Debian support x64 and ARM64; Arch Linux supports x64; macOS 26+ supports Apple Silicon. The first macOS installation needs the xattr command in the guide. The native desktop pet currently supports Linux only.' },
  ...
  final: {
    ...
    platforms: 'macOS · Windows · Ubuntu / Debian · Arch Linux',
    note: 'x64 / ARM64 installers · Bring your own model service',
